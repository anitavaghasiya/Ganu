...
public class FavoriteOutwardProductActivity extends AppCompatActivity {
    ...
    private int isFrom = 2, i = 0;
    private String grade_id, shape_id, location_id, size_id;
    private List<FavoriteProduct> data = new ArrayList<> ();

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate (savedInstanceState);
        setContentView (R.layout.activity_favorite_outward_product);
        ...
        if (Common.isConnectingToInternet (mContext)) {
            favoriteProductList = PrefFavoriteProduct.getOutwardFavorites (mContext);
            ...
            API.ProductData ().getFilterProductData (prefManager.getToken (), prefManager.getRegId (), size_id, location_id, shape_id, grade_id).enqueue (new retrofit2.Callback<ProductResponse> () {
                ...
                public void onResponse(Call<ProductResponse> call, Response<ProductResponse> response) {
                    ...
                    if (productResponse.getErrorCode () == 200) {
                        ...
                        Log.e ("grade_id", "grade_id: " + grade_id);
                        Log.e ("size_id", "size_id: " + size_id);
                        Log.e ("loction_id", "loction_id: " + location_id);
                        Log.e ("shape_id", "shape_id: " + shape_id);
    ...
    public void getFavoriteOutwardProdcut() {
        if (data != null && data.size () > 0) {
            Common.dismissDialog ();
            rv_fav_product.setVisibility (View.VISIBLE);
            tv_no_data_found.setVisibility (View.GONE);
            favProductAdapter = new FavProductAdapter (mContext, data, "outward");
    ...
    public void updateOutwardProduct(String shape_id, String grade_id, String location_id, String size_id, String length, String weight, String pieces) {
        Common.showProgressDialog (mContext);
