...
import com.ganak.fragment.AddOutwardProductFragment;
import com.ganak.model.Shape;

import java.util.ArrayList;
import java.util.List;

public class ShapeOutwardAdapter extends RecyclerView.Adapter<ShapeOutwardAdapter.ProductViewHolder> implements Filterable {
    ...
    public ShapeOutwardAdapter(Context mCtx, List<Shape> productList, String name_shape) {
        this.mCtx = mCtx;
    ...
    public ShapeOutwardAdapter(Context mCtx, List<Shape> productList, String name_shape, String name_shape_id) {
        this.mCtx = mCtx;
        this.productList = productList;
        this.shapeListFiltered = productList;
        this.name_shape = name_shape;
    ...
    public void onBindViewHolder(ProductViewHolder holder, final int position) {
        ...
        holder.textViewTitle.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Fragment myFragment = new AddOutwardProductFragment();
